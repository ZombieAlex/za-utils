...
var _ExpiringSet_options, _ExpiringSet_map;
...
export class ExpiringSet {
     ...
     */
    constructor(options) {
        _ExpiringSet_options.set(this, void 0);
        _ExpiringSet_map.set(this, void 0);
        __classPrivateFieldSet(this, _ExpiringSet_options, options, "f");
        __classPrivateFieldSet(this, _ExpiringSet_map, new Map(), "f");
    }
    /**
     * Removes all values from the set. No expiry callbacks are invoked.
     */
    clear() {
        for (const key of __classPrivateFieldGet(this, _ExpiringSet_map, "f").keys()) {
            this.delete(key);
        }
    }
    /**
     ...
     */
    delete(value) {
        clearTimeout(__classPrivateFieldGet(this, _ExpiringSet_map, "f").get(value)?.timer);
        return __classPrivateFieldGet(this, _ExpiringSet_map, "f").delete(value);
    }
    /**
    ...
    *entries() {
     ...
     */
    has(value) {
        return __classPrivateFieldGet(this, _ExpiringSet_map, "f").has(value);
    }
    /**
     ...
     */
    getExpiry(value) {
        return __classPrivateFieldGet(this, _ExpiringSet_map, "f").get(value)?.expiry;
    }
    /**
    ...
    add(value, { expiryMs, expiryCallback } = {}) {
        ...
        let timer;
        let expiry;
        expiryMs ?? (expiryMs = __classPrivateFieldGet(this, _ExpiringSet_options, "f")?.defaultExpiryMs);
        expiryCallback ?? (expiryCallback = __classPrivateFieldGet(this, _ExpiringSet_options, "f")?.defaultExpiryCallback);
        if (typeof expiryMs === "number") {
            ...
            }, __classPrivateFieldGet(this, _ExpiringSet_options, "f")?.expireErrorCallback), expiryMs);
        }
        __classPrivateFieldGet(this, _ExpiringSet_map, "f").set(value, { timer, expiry, expiryCallback });
        return this;
    }
    /**
     ...
     */
    clearExpiry(value) {
        if (__classPrivateFieldGet(this, _ExpiringSet_map, "f").has(value)) {
            const entry = __classPrivateFieldGet(this, _ExpiringSet_map, "f").get(value);
    ...
    setExpiry(value, msFromNow) {
        if (__classPrivateFieldGet(this, _ExpiringSet_map, "f").has(value)) {
            const { expiryCallback } = __classPrivateFieldGet(this, _ExpiringSet_map, "f").get(value);
     ...
     */
    get size() {
        return __classPrivateFieldGet(this, _ExpiringSet_map, "f").size;
    }
    /**
     ...
     */
    values() {
        return __classPrivateFieldGet(this, _ExpiringSet_map, "f").keys();
    }
    /**
     * @returns an iterable of values in the set.
     */
    [(_ExpiringSet_options = new WeakMap(), _ExpiringSet_map = new WeakMap(), Symbol.iterator)]() {
        return this.values();
    }
