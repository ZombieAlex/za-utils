 ...
 * @param param1
 */
export function assertShape(object, { strings = [], stringPaths = [], numbers = [], numberPaths = [], booleans = [], booleanPaths = [], arrays = [], arrayPaths = [], objects = [], objectPaths = [], functions = [], functionPaths = [], optionals = [], strict = false, }) {
